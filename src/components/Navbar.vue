...
<template>
  <nav class="border-b" style="border-color: var(--line)">
    <div
      class="max-w-6xl mx-auto px-6 py-5 relative flex items-center justify-between"
    >
      <!-- Logo - leva strana -->
      ...
      >
        ...
        <router-link to="/termini" class="hover:text-black transition"
          >Termini</router-link
        >
        <router-link to="/o-nama" class="hover:text-black transition"
          >O nama</router-link
        >
        <router-link to="/pitanja" class="hover:text-black transition"
      ...
      <div class="flex items-center">
        <router-link
          ...
          to="/login"
          class="text-sm hover:text-black transition"
